    ...
    <section class="mt-8">
        ...
        <form action="#" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" id="goalDeadline" name="goalDeadline" class="form-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
            </div>
